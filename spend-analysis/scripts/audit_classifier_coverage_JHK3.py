...
TEST_PHRASES = [
    ...
    ("Equipment Rental & Leasing", "rental equipment"),
    ("Equipment Rental & Leasing", "rental equipment & supplies"),
    ("Equipment Rental & Leasing", "heavy equipment rental"),
    ("Equipment Rental & Leasing", "vehicle rental"),
    ("Equipment Rental & Leasing", "car rental"),
    ("Equipment Rental & Leasing", "automobile rental"),
    ("Equipment Rental & Leasing", "automobile leasing"),
    ("Equipment Rental & Leasing", "tent rental"),
    ("Equipment Rental & Leasing", "copier lease"),
