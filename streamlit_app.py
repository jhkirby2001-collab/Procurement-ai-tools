...
def page_methodology() -> None:
          ...
          <table style="width:100%; border-collapse: collapse; font-size: 14px;">
            ...
            <tbody>
              <tr style="background:{CHI_LT_BLUE};">
                ...
                <td style="padding:8px 10px;">280 curated + 6,766 AI-mined rules match the description text. Strongest evidence.</td>
              </tr>
              <tr>
    ...
    st.markdown(
        ...
        "2. **Rule matching.** The chosen description is matched against the 7,046-rule "
        "catalog (280 curated + 6,766 AI-mined). Every rule was pre-authored with an "
    ...
    st.markdown(
        ...
        "— derived from a real-world public-sector procurement transaction history (EY raw "
        "data), validated against the public NIGP framework. "
        ...
        "<strong>Hand-curated rules (280)</strong> — authored by James H. Kirby III, "
...
def page_taxonomy_logic() -> None:
    ...
    st.markdown(
        ...
        "<strong>**</strong>** — the actual NIGP codes that appeared in the EY raw data "
        "were extracted from the source dataset and "
    ...
    st.markdown(
        ...
        "transaction history (EY raw data), validated against "
