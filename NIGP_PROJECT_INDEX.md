...
| File | What it is |
|---|---|
| [spend-analysis/data/reference/keyword_rules_DRAFT_JHK3.csv](spend-analysis/data/reference/keyword_rules_DRAFT_JHK3.csv) | 280 hand-curated keyword rules. The highest-volume hitters. |
