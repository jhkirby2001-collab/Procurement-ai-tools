...
| 3 | **Spend Report** | Upload a spend file in **any format** → it profiles every column, then runs every analysis the data supports (category, Pareto, top vendors, concentration/HHI, tail-spend, single-vs-multi-source, trend, department, category×dept matrix, consolidation, **same-item-across-vendors/departments**, same-commodity-by-NIGP-code, contract/diversity/any-dimension) + a **Savings Opportunity Summary** (addressable spend → **hard savings + cost avoidance**, annualized + 3-year projection), **Top Consolidation Opportunities** with recommended actions, professional charts, and a **Sources & Methodology** tab citing real references. Every row lands in one of the 17 Business Categories (General & Other absorbed via best-fit). Deterministic classification, rules-only. | Anyone analyzing a spend file |
...
| 8 | **Rule Lookup** | Search across all 7,102 rules (336 hand-curated + 6,766 AI-mined) to verify how any specific phrase routes. | Anyone validating a classification decision |
...
| Question | Answer |
|---|---|
| "How many rules?" | 7,102 total: 336 hand-curated + 6,766 AI-mined |
